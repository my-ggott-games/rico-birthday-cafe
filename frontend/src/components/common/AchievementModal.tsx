            ...
            >
                ...
                >
                    ...
                    <div className="mb-5 shrink-0 bg-pale-custard rounded-2xl border-2 border-[#D6C0B0] p-4">
                        <p className="text-xs font-bold uppercase tracking-widest text-[#166D77]/50 mb-2">내 디바이스 ID</p>
                        <div className="flex items-center gap-3">
                            ...
                            <motion.button
                                ...
                                style={
                                    copied
                                        ? { background: '#5EC7A5', color: '#FFFFF8', borderColor: '#5EC7A5' }
                                        : { background: '#166D77', color: '#bef264', borderColor: '#166D77' }
                                }
                            >
                                {copied ? '✓ 복사됨' : '복사'}
                            </motion.button>
                    ...
                    <div className="flex-1 overflow-y-auto pr-1 custom-scrollbar min-h-0">
                        {loading ? (
                            ...
                            <div className="text-center py-10 bg-pale-custard rounded-3xl border-4 border-dashed border-[#D6C0B0]">
                                <span className="text-5xl grayscale opacity-40 block mb-3">🔒</span>
                                <p className="text-[#166D77] font-bold">로그인 후 업적을 확인하세요!</p>
                            </div>
                        ) : achievements.length === 0 ? (
                            <div className="text-center py-10 bg-pale-custard rounded-3xl border-4 border-dashed border-[#D6C0B0]">
                                <span className="text-6xl grayscale opacity-50 block mb-4">🎖️</span>
                                <p className="text-[#166D77] font-bold text-xl">아직 업적이 없어요.</p>
                                <p className="text-[#166D77]/60 mt-2">게임을 플레이해서 특별한 배지를 획득하세요!</p>
                            </div>
                        ) : (
