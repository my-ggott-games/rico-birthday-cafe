        ...
        {toasts.map((toast) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0 z-10">
              <h4 className="text-[#166D77] font-black text-sm truncate">
                Achievement Unlocked!
              </h4>
              <p className="text-[#5EC7A5] font-bold text-lg truncate leading-tight">
                {toast.title}
              </p>
              <p className="text-[#166D77]/70 text-xs font-medium truncate mt-0.5">
                {toast.description}
              </p>
            </div>
            <button
