...
export function AdventureGamePanelMobile({
  ...
  return (
    <section
      ...
      className="w-full rounded-[1.7rem] border-4 border-[#102542]/10 bg-white/80 p-2.5 shadow-[0_20px_45px_rgba(17,24,39,0.12)]"
    >
      <div className="flex justify-center">
        ...
        >
          <div className="relative h-[25rem] w-full touch-none overscroll-none">
            {gameCanvas}
          </div>
