...
import { Tutorial } from '../components/asparagus/Tutorial';
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 items-center px-8 pt-10 pb-6 gap-4">
                ...
                <div className="flex justify-center lg:justify-end gap-3 order-3">
            ...
            <div className="flex-1 w-full grid grid-cols-1 lg:grid-cols-3 px-10 pb-12 gap-8">
                ...
                {/* [Left] Tutorial: Horizontal Center / Vertical Start */}
                ...
                {/* [Center] Board: Horizontal Center / Vertical Start */}
                <div className="flex flex-col items-center justify-start lg:pt-10">
                    <Board
                        grid={grid}
                        selection={selection}
                ...
                {/* [Right] Items: Horizontal Center / Vertical Start */}
                <div className="flex flex-col items-center justify-start lg:pt-10">
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(4px)' }}>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2 w-full">
                                ...
                                <button onClick={() => navigate('/lobby')} className="w-full py-2.5 rounded-2xl font-black text-sm bg-[#166D77] text-white">로비로 이동</button>
                            </div>
                        </motion.div>
                    </div>
                )}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(4px)' }}>
                        ...
                        >
                            ...
                            <div className="flex gap-2 w-full mt-2">
                                ...
                                <button onClick={() => navigate('/lobby')} className="flex-1 py-3 rounded-2xl font-black text-sm bg-[#166D77] text-white">로비</button>
                            </div>
                        </motion.div>
                    </div>
                )}
